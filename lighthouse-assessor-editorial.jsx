...
function AssessorEditorial() {
  ...
  // Brand roles are CSS vars so the whole flow — headings, CTAs, rings, badges,
  // tooltips, drawers, dialogs — re-themes with the client brand (Marsh / General /
  // DG) exactly like Folio. Defaults come from brand.css: --primary/--action #000F47,
  // --accent #0065AC. Body inks + surfaces below stay neutral (never rebranded).
  const navy = "var(--primary)";        // midnight — primary brand (fills, headings, rail)
  const teal = "var(--accent)";         // MDS accent — active, rings, progress
  const gold = "var(--accent)";         // accent — rail active, toggles, badges, section accents
  const goldDark = "color-mix(in srgb, var(--accent) 80%, #000)"; // accent-hover
  const tealBg = "color-mix(in srgb, var(--accent) 8%, transparent)";
  const navyBg = "color-mix(in srgb, var(--primary) 5%, transparent)";
  ...
  const css = `
    ...
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    ::-webkit-scrollbar-thumb{background:color-mix(in srgb, var(--primary) 8%, transparent);border-radius:3px}
  ...
  const I = {
    ...
    Sparkle:(p)=><svg width={p?.s||14} height={p?.s||14} viewBox="0 0 24 24" fill="currentColor" dangerouslySetInnerHTML={{__html:`<path d="M 5.852 6.019 L 3.207 3.375 L 4.277 2.306 L 6.921 4.95 L 5.852 6.019 Z M 9.635 3.75 L 9.635 0 L 11.135 0 L 11.135 3.75 L 9.635 3.75 Z M 16.467 16.635 L 13.823 13.991 L 14.892 12.921 L 17.537 15.566 L 16.467 16.635 Z M 15.084 5.827 L 14.015 4.758 L 16.66 2.113 L 17.729 3.183 L 15.084 5.827 Z M 16.092 10.208 L 16.092 8.708 L 19.842 8.708 L 19.842 10.208 L 16.092 10.208 Z M 2.529 19.562 L 0.271 17.304 C 0.09 17.123 0 16.912 0 16.671 C 0 16.43 0.09 16.219 0.271 16.039 L 9.067 7.227 C 9.552 6.74 10.142 6.496 10.835 6.496 C 11.528 6.496 12.118 6.739 12.606 7.225 C 13.093 7.71 13.337 8.3 13.337 8.994 C 13.337 9.688 13.093 10.278 12.606 10.766 L 3.794 19.562 C 3.613 19.742 3.402 19.833 3.161 19.833 C 2.92 19.833 2.71 19.742 2.529 19.562 Z M 3.161 18.096 L 9.436 11.821 L 8.012 10.421 L 1.761 16.671 L 3.161 18.096 Z" fill="currentColor" fill-rule="evenodd" transform="matrix(1 0 0 1 2.616 1.542)"/>`}}/>,
    Drag:(p)=><svg width={p?.s||10} height={p?.s||10} viewBox="0 0 24 24" fill="currentColor" dangerouslySetInnerHTML={{__html:`<path d="M 1.615 15.23 C 1.171 15.23 0.791 15.072 0.474 14.756 C 0.158 14.44 0 14.059 0 13.615 C 0 13.171 0.158 12.791 0.474 12.474 C 0.791 12.158 1.171 12 1.615 12 C 2.059 12 2.44 12.158 2.756 12.474 C 3.072 12.791 3.23 13.171 3.23 13.615 C 3.23 14.059 3.072 14.44 2.756 14.756 C 2.44 15.072 2.059 15.23 1.615 15.23 Z M 7.615 15.23 C 7.171 15.23 6.791 15.072 6.474 14.756 C 6.158 14.44 6 14.059 6 13.615 C 6 13.171 6.158 12.791 6.474 12.474 C 6.791 12.158 7.171 12 7.615 12 C 8.059 12 8.44 12.158 8.756 12.474 C 9.072 12.791 9.23 13.171 9.23 13.615 C 9.23 14.059 9.072 14.44 8.756 14.756 C 8.44 15.072 8.059 15.23 7.615 15.23 Z M 1.615 9.23 C 1.171 9.23 0.791 9.072 0.474 8.756 C 0.158 8.44 0 8.059 0 7.615 C 0 7.171 0.158 6.791 0.474 6.474 C 0.791 6.158 1.171 6 1.615 6 C 2.059 6 2.44 6.158 2.756 6.474 C 3.072 6.791 3.23 7.171 3.23 7.615 C 3.23 8.059 3.072 8.44 2.756 8.756 C 2.44 9.072 2.059 9.23 1.615 9.23 Z M 7.615 9.23 C 7.171 9.23 6.791 9.072 6.474 8.756 C 6.158 8.44 6 8.059 6 7.615 C 6 7.171 6.158 6.791 6.474 6.474 C 6.791 6.158 7.171 6 7.615 6 C 8.059 6 8.44 6.158 8.756 6.474 C 9.072 6.791 9.23 7.171 9.23 7.615 C 9.23 8.059 9.072 8.44 8.756 8.756 C 8.44 9.072 8.059 9.23 7.615 9.23 Z M 1.615 3.23 C 1.171 3.23 0.791 3.072 0.474 2.756 C 0.158 2.44 0 2.059 0 1.615 C 0 1.171 0.158 0.791 0.474 0.474 C 0.791 0.158 1.171 0 1.615 0 C 2.059 0 2.44 0.158 2.756 0.474 C 3.072 0.791 3.23 1.171 3.23 1.615 C 3.23 2.059 3.072 2.44 2.756 2.756 C 2.44 3.072 2.059 3.23 1.615 3.23 Z M 7.615 3.23 C 7.171 3.23 6.791 3.072 6.474 2.756 C 6.158 2.44 6 2.059 6 1.615 C 6 1.171 6.158 0.791 6.474 0.474 C 6.791 0.158 7.171 0 7.615 0 C 8.059 0 8.44 0.158 8.756 0.474 C 9.072 0.791 9.23 1.171 9.23 1.615 C 9.23 2.059 9.072 2.44 8.756 2.756 C 8.44 3.072 8.059 3.23 7.615 3.23 Z" fill="currentColor" fill-rule="evenodd" transform="matrix(1 0 0 1 2 2) matrix(1 0 0 1 5.380 2.380)"/>`}}/>,
    Flag:(p)=><svg width={p?.s||14} height={p?.s||14} viewBox="0 0 24 24" fill="currentColor" dangerouslySetInnerHTML={{__html:`<path d="M 12.914 0.349 C 12.793 0.134 12.564 0 12.315 0 L 0.685 0 C 0.307 0 0 0.303 0 0.678 L 0 10.321 C 0 10.696 0.307 11 0.685 11 L 12.315 11 C 12.564 11 12.793 10.865 12.914 10.65 C 13.035 10.434 13.028 10.171 12.896 9.962 L 10.077 5.5 L 12.896 1.037 C 13.028 0.828 13.035 0.565 12.914 0.349 Z" fill="currentColor" fill-rule="nonzero" transform="matrix(1 0 0 1 2 2) matrix(1 0 0 1 5 2)"/><path d="M 0.675 0 C 1.048 0 1.35 0.302 1.35 0.675 L 1.35 19.325 C 1.35 19.698 1.048 20 0.675 20 C 0.302 20 0 19.698 0 19.325 L 0 0.675 C 0 0.302 0.302 0 0.675 0 Z" fill="currentColor" fill-rule="nonzero" transform="matrix(1 0 0 1 2 2) matrix(1 0 0 1 2 0)"/>`}}/>,
  ...
  // ═══════ STATUS STYLES ═══════
  // MDS Badge mapping (soft-background variants): Informative var(--accent), Positive
  ...
  const statusStyle = (s) => ({
    "Not started":NEUTRAL,
    "Not Started":NEUTRAL,
    "In progress":{c:"var(--accent)", bg:"color-mix(in srgb, var(--accent) 15%, #ffffff)"},
    "In Progress":{c:"var(--accent)", bg:"color-mix(in srgb, var(--accent) 15%, #ffffff)"},
    ...
    "Scheduled":{c:"var(--accent)", bg:"color-mix(in srgb, var(--accent) 15%, #ffffff)"},
    "No Status":NEUTRAL,
          ...
          {profileOpen && (
            <div style={{position:"absolute",top:"calc(100% + 6px)",right:0,background:card,border:`1px solid ${bd}`,borderRadius:12,boxShadow:`0 12px 40px rgba(0,15,71,.18)`,minWidth:280,padding:6,zIndex:30}}>
              ...
              {[
                ...
                <div key={o.l} onClick={()=>{setProfileOpen(false);o.fn();}} style={{display:"flex",alignItems:"center",gap:13,padding:"13px 16px",fontSize:14,fontWeight:400,color:tx,cursor:"pointer",borderTop:`1px solid ${bd}`}} onMouseEnter={e=>e.currentTarget.style.background=bg2} onMouseLeave={e=>e.currentTarget.style.background="transparent"}><span style={{color:tm,display:"inline-flex"}}>{o.icon}</span>{o.l}</div>
              ))}
            </div>
          )}
        </div>
        ...
        {open && (
          <div style={{position:"absolute",top:"100%",left:16,zIndex:30,marginTop:4,width:230,background:card,border:`1px solid ${bd}`,borderRadius:8,boxShadow:"0 12px 34px rgba(0,15,71,.16)",padding:8}}>
            <div style={{display:"flex",alignItems:"center",gap:6,padding:"6px 9px",background:bg,border:`1px solid ${bd}`,borderRadius:6}}>
              ...
              <input autoFocus value={dashQ} onChange={e=>setDashQ(e.target.value)} onClick={e=>e.stopPropagation()} placeholder="Search candidate…" style={{border:"none",outline:"none",flex:1,fontSize:14,background:"transparent",color:navy,fontWeight:400}}/>
                  ...
                  <tr key={c.id} className="rh" style={{cursor:"pointer",background:"#fff",borderBottom:i===rows.length-1?"none":`1px solid ${bd}`}} onClick={()=>{setEntryPath("participant"); setSubjectId(c.id); setRoute("candidate"); setCandidateTab("assessments");}}>
                    ...
                    <td style={{padding:"16px"}}>
                      <div style={{display:"flex",alignItems:"center",gap:10}}>
                        <div style={{width:32,height:32,borderRadius:"50%",background:`color-mix(in srgb, var(--accent) 10%, transparent)`,color:teal,display:"flex",alignItems:"center",justifyContent:"center",fontSize:14,fontWeight:700,flexShrink:0}}>{c.name.split(" ").map(n=>n[0]).slice(0,2).join("")}</div>
                        <div style={{minWidth:0}}>
                    ...
                    <td style={{padding:"16px"}}>
                      <div style={{display:"inline-flex",alignItems:"center",gap:10}}>
                        ...
                        <span className="tnum" style={{fontSize:14,color:tm,fontWeight:400}}>{c.evalDone}/{c.evalTotal}</span>
                      </div>
                    </td>
            ...
            const searchHead = () => { const open=cdOpenFilter==="nameSearch", active=!!cdQ; return (
              <th style={cTh}>
                ...
                {open && (<div style={{position:"absolute",top:"100%",left:16,zIndex:30,marginTop:4,width:230,background:card,border:`1px solid ${bd}`,borderRadius:8,boxShadow:"0 12px 34px rgba(0,15,71,.16)",padding:8}}>
                  <div style={{display:"flex",alignItems:"center",gap:6,padding:"6px 9px",background:bg,border:`1px solid ${bd}`,borderRadius:6}}>
                    <I.Search s={13} style={{color:tm}}/>
                    <input autoFocus value={cdQ} onChange={e=>setCdQ(e.target.value)} onClick={e=>e.stopPropagation()} placeholder="Search candidate…" style={{border:"none",outline:"none",flex:1,fontSize:14,background:"transparent",color:navy,fontWeight:400}}/>
    ...
    return (
      <div className="an1" data-screen-label="02 Candidate detail" style={{padding:"32px 40px 80px",maxWidth:1400,margin:"0 auto"}}>
        ...
        <div style={{display:"flex",alignItems:"flex-start",gap:24,marginBottom:28,flexWrap:"wrap"}}>
          <div style={{width:72,height:72,borderRadius:"50%",background:`color-mix(in srgb, var(--accent) 10%, transparent)`,color:teal,display:"flex",alignItems:"center",justifyContent:"center",fontSize:24,fontWeight:700,flexShrink:0}}>{c.name.split(" ").map(n=>n[0]).slice(0,2).join("")}</div>
          <div style={{flex:1,minWidth:280}}>
            <h1 className="display" style={{fontSize:32,marginBottom:6}}>{c.name}</h1>
            <div style={{fontSize:14,color:ts}}>{c.email}</div>
          </div>
          <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
            <button onClick={()=>setRoute("evaluate")} className="btn btn-secondary"><I.EditDocument s={13}/> Evaluate</button>
        ...
        <div style={{border:`1px solid ${bd}`,borderRadius:br,background:card,marginBottom:28,overflow:"hidden",display:"grid",gridTemplateColumns:isNarrow?"1fr 1fr":"repeat(4,1fr)"}}>
          {[["Candidate ID", c.id],["Grade", c.profile.grade],["Entity", c.profile.entity],["Compliance", c.profile.compliance],["Language", c.profile.lang],["Current role", c.profile.currentRole],["Target level", c.profile.targetLevel],["Cognitive band", c.profile.raven]].map(([k,v],i)=>{
            ...
            <div key={i} style={{padding:"12px 18px",borderTop:i>=cols?`1px solid ${bd}`:"none",borderLeft:(i%cols)!==0?`1px solid ${bd}`:"none",minWidth:0}}>
              <div style={{fontSize:14,color:tm,fontWeight:400,marginBottom:5}}>{k}</div>
              <div style={{fontSize:14,color:tx,fontWeight:400}} className="elide">{v}</div>
            </div>);
          })}
        </div>
        ...
        {candidateTab === "assessments" && (
          <div className="an" style={{display:"flex",flexDirection:"column",gap:30}}>
            <div>
              <p className="eyebrow" style={{marginBottom:12}}>Assessments <span style={{color:tf,fontWeight:400}}>({assessments.length})</span></p>
              <AssessmentsList/>
            </div>
            <div>
              <p className="eyebrow" style={{marginBottom:12}}>Reports <span style={{color:tf,fontWeight:400}}>({reports.length})</span></p>
              <ReportsList/>
            </div>
          </div>
        )}
        ...
        <dl style={{fontSize:14,margin:0}}>
          {[
            ...
            <div key={i} style={{display:"flex",justifyContent:"space-between",gap:12,padding:"10px 0",borderBottom:i===7?"none":`1px solid ${bd}`}}>
              ...
              <dd style={{color:tx,fontWeight:400,textAlign:"right"}}>{v}</dd>
            </div>
          ))}
        </dl>
      </aside>
        ...
        <tbody>
          {assessments.map((a,i) => (
            <tr key={a.id} className="rh" style={{cursor:"pointer",borderTop:i===0?"none":`1px solid ${bd}`}} onClick={()=>setRoute("evaluate")}>
              <td style={{padding:"16px 18px"}}><span className="tnum" style={{fontSize:14,color:tm,fontWeight:400}}>{a.id}</span></td>
              <td style={{padding:"16px 18px"}}>
                <div style={{fontSize:14,fontWeight:400,color:tx,marginBottom:2}}>{a.name}</div>
                <div style={{fontSize:14,color:tm,letterSpacing:0,textTransform:"none",fontWeight:400}}>{a.type} Form</div>
              </td>
              <td style={{padding:"16px 18px"}}>
                <div style={{display:"flex",alignItems:"center",gap:10,maxWidth:220}}>
                  ...
                  <span className="tnum" style={{fontSize:14,color:tx,fontWeight:400}}>{Math.round(a.progress*100)}%</span>
                </div>
              </td>
        ...
        <tbody>
          {shown.map((r,i) => {
            ...
            <tr key={r.id} className="rh" style={{cursor:avail?"pointer":"default",borderTop:i===0?"none":`1px solid ${bd}`}} onClick={()=>{ if(avail) setOpenReport(r); }}>
              <td style={{padding:"16px 18px"}}><span className="tnum" style={{fontSize:14,color:tm,fontWeight:400}}>{r.id}</span></td>
              <td style={{padding:"16px 18px"}}>
                <div style={{display:"flex",alignItems:"center",gap:10}}>
          ...
          <tbody>
            ...
            {recordings.map((r,i)=>(
              <tr key={r.id} className="rh">
                <td style={rTd}><span style={{color:teal,fontWeight:400}}>{i+1}</span></td>
      ...
      <div className="an1" data-screen-label="04 Moderate" style={{height:"100%",position:"relative",display:"flex",flexDirection:"column"}}>
        ...
        <div style={{padding:"18px 32px 0",borderBottom:`1px solid ${bd}`,background:bg}}>
          <div style={{display:"flex",alignItems:"center",gap:20,flexWrap:"wrap",marginBottom:14}}>
            <div style={{flex:1,minWidth:200,display:"flex",alignItems:"center",gap:12,flexWrap:"wrap"}}>
              <div style={{width:34,height:34,borderRadius:"50%",background:`color-mix(in srgb, var(--accent) 10%, transparent)`,color:teal,display:"flex",alignItems:"center",justifyContent:"center",fontSize:14,fontWeight:700,flexShrink:0}}>{c.name.split(" ").map(n=>n[0]).slice(0,2).join("")}</div>
                    ...
                    {competencies.map((cc, ccIdx) => {
                      ...
                      return (
                        <React.Fragment key={cc.id}>
                          ...
                          <tr style={{background:compHasError?`${red}08`:(open?`color-mix(in srgb, var(--primary) 2.5%, transparent)`:"#fff"),borderTop:ccIdx>0?`1px solid ${bd}`:"none"}}>
                            ...
                            return (
                              <tr key={ind.id} style={{background:outOfRange?`${red}08`:card}}>
                                ...
                                <td style={{position:"sticky",right:finalColW+avgColW,zIndex:1,background:outOfRange?"#FDF2F2":card,padding:"6px 10px",textAlign:"center",borderLeft:`2px solid ${outOfRange?red:navy}`,borderBottom:`1px solid ${bd}`,width:rangeColW,minWidth:rangeColW}}>
                                  {iRange ? <span className="tnum" style={{fontSize:14,color:outOfRange?red:tm,fontWeight:400,whiteSpace:"nowrap"}}>{fmtR(iRange[0])} – {fmtR(iRange[1])}</span> : <span style={{color:tf}}>—</span>}
                                </td>
                                ...
                                <td style={{position:"sticky",right:0,zIndex:1,background:outOfRange?"#FDF2F2":card,padding:"6px 10px",textAlign:"center",borderLeft:`2px solid ${outOfRange?red:navy}`,borderBottom:`1px solid ${bd}`,width:finalColW,minWidth:finalColW}}>
                                  <div style={{display:"inline-flex",alignItems:"center",gap:8}}>
                                    ...
                                    <button onClick={()=>setNA(ind.id,!isNA)} title={isNA?"Not applicable — score locked":"Editable — click to mark not applicable"} aria-pressed={isNA} style={{display:"inline-block",boxSizing:"border-box",width:54,height:20,borderRadius:999,background:isNA?"var(--primary)":"transparent",border:isNA?"none":"1px solid #B9B6B1",cursor:"pointer",transition:"all .15s",position:"relative",verticalAlign:"middle"}}>
                ...
                return (
                  <div className="an" style={{marginTop:20,border:`1px solid ${bd}`,borderRadius:br,background:card,overflow:"hidden"}}>
                    <div style={{display:"flex",alignItems:"center",gap:14,padding:"14px 20px",borderBottom:`1px solid ${bd}`,background:sbBg}}>
                      ...
                      <div style={{flex:1}}/>
                      <span className="tag" style={{background:`color-mix(in srgb, var(--primary) 8%, transparent)`,color:navy}}>{assessorRoster[activeCell.aIdx] || `Assessor ${activeCell.aIdx+1}`} · {af.exercise}</span>
        ...
        <div style={{width:railW,flexShrink:0,background:card,borderLeft:`1px solid ${bd}`,display:"flex",flexDirection:"column",alignItems:"center",gap:4,padding:"14px 0",zIndex:12}}>
          {[
            ...
            return (
              <button key={b.k} onClick={()=>toggleDrawer(b.k)} title={b.l} style={{display:"flex",alignItems:"center",justifyContent:"center",width:railW-12,height:railW-16,borderRadius:br,background:open?`color-mix(in srgb, var(--accent) 9%, transparent)`:"transparent",color:open?teal:ts,cursor:"pointer",border:`1px solid ${open?teal:"transparent"}`,transition:"all .15s"}}>
                <b.I s={19}/>
              </button>
            );
          })}
    ...
    return (
      <div>
        <div style={{display:"flex",alignItems:"baseline",gap:12,marginBottom:8}}>
          ...
          <div style={{flex:1}}/>
          <span className="tnum" style={{fontSize:14,fontWeight:400,color:words>max?red:words>0?green:tm}}>{words} / {max} words</span>
        </div>
    ...
    return (
      <div style={{marginBottom:28}}>
        ...
        <div style={{display:"flex",alignItems:"baseline",gap:8,margin:"16px 0 6px"}}>
          ...
          <span style={{flex:1}}/>
          <span className="tnum" style={{fontSize:14,fontWeight:400,color:words>50?red:words>0?green:tf}}>{words} / 50 words</span>
        </div>
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(3, minmax(0,1fr))",gap:0,background:card,border:`1px solid ${bd}`,borderRadius:br,flex:"1 1 240px",minWidth:0}}>
            {[["Grade",p.grade],["Entity",p.entity],["Compliance",p.compliance]].map(([k,v],i) => (
              <div key={k} style={{padding:"14px 12px",textAlign:"center",minWidth:0,borderRight:i<2?`1px solid ${bd}`:"none"}}>
                <div style={{fontSize:14,color:tm,fontWeight:400,marginBottom:6}}>{k}</div>
      ...
      <div>
        ...
        <div style={{padding:"16px 20px"}}>
          ...
          <div style={{marginBottom:14}}>
            <label style={{fontSize:14,color:tm,fontWeight:400,letterSpacing:0,textTransform:"none",display:"block",marginBottom:6}}>Assessor</label>
          ...
          <div style={{display:"flex",flexWrap:"wrap",gap:6}}>
            {competencies.slice(0, selected===0?4:selected===1?3:2).map(cc => (
              <span key={cc.id} className="tag" style={{background:`color-mix(in srgb, var(--accent) 7%, transparent)`,color:teal}}>{cc.id} · {cc.name}</span>
            ))}
          </div>
        </div>
      </div>
    ...
    <div style={{padding:"16px 20px"}}>
      {recordings.map(r => (
        <div key={r.id} style={{display:"flex",alignItems:"flex-start",gap:12,padding:"14px 0",borderBottom:`1px solid ${bd}`}}>
          ...
          <div style={{flex:1,minWidth:0}}>
            <div style={{fontSize:14,fontWeight:400,color:tx,marginBottom:2}}>{r.label}</div>
  ...
  const ACampaignDetail = () => {
    ...
    const renderVal = (v) => {
      ...
      return <span style={{color:tx,fontWeight:400}}>{v}</span>;
    };
    return (
      <div className="an1" data-screen-label="Assessment Center — Campaign" style={{padding:"24px 40px 80px",maxWidth:1400,margin:"0 auto"}}>
        ...
        <div style={{border:`1px solid ${bd}`,borderRadius:br,background:card,marginBottom:28,overflow:"hidden",display:"grid",gridTemplateColumns:vw<760?"1fr 1fr":"repeat(4,1fr)"}}>
          {metaItems.map((m,i)=>{
            ...
            return (
            <div key={i} style={{padding:"12px 18px",borderTop:i>=cols?`1px solid ${bd}`:"none",borderLeft:(i%cols)!==0?`1px solid ${bd}`:"none",minWidth:0}}>
              <div style={{fontSize:14,color:tm,fontWeight:400,marginBottom:5,letterSpacing:0}}>{m.label}</div>
              ...
              <div style={{display:"flex",gap:28,padding:"0 22px 20px"}}>
                {["Open","Closed"].map(o=>(
                  <label key={o} style={{display:"flex",alignItems:"center",gap:9,cursor:"pointer"}}>
                    ...
                    <span style={{fontSize:14,color:tx,fontWeight:400}}>{o}</span>
                  </label>
                ))}
              </div>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:14}}>
            {dayNames.map((dn,i)=> d.active[i] && (norm(d.rows)[i]).map((slot,si)=>(
              <div key={i+"-"+si} style={{display:"flex",alignItems:"center",gap:14,flexWrap:"wrap"}}>
                <div style={{width:110,fontSize:14,fontWeight:400,color:tx}}>{si===0?dn:""}</div>
              ...
              {open && (
                <div style={{padding:"20px 24px"}}>
                  <div style={{display:"grid",gridTemplateColumns:isNarrow?"1fr":"repeat(3,1fr)",gap:18,marginBottom:20,maxWidth:600}}>
                    <div><div className="eyebrow" style={{marginBottom:5}}>TimeZone</div><div style={{fontSize:14,fontWeight:400,color:tx}}>{a.tz}</div></div>
                    <div><div className="eyebrow" style={{marginBottom:5}}>Start Date</div><div style={{fontSize:14,fontWeight:400,color:tx}}>{fmtDate(a.start)||"—"}</div></div>
                    <div><div className="eyebrow" style={{marginBottom:5}}>End Date</div><div style={{fontSize:14,fontWeight:400,color:tx}}>{fmtDate(a.end)||"—"}</div></div>
                  </div>
                  <div style={{display:"flex",flexDirection:"column",gap:8,maxWidth:420}}>
                    {dayNamesAv.map((dn,i)=> a.active[i] && (
                      <div key={i} style={{display:"flex",alignItems:"center",gap:12,padding:"8px 0",borderTop:`1px solid ${bd}`}}>
                        <div style={{width:110,fontSize:14,fontWeight:400,color:tx}}>{dn}</div>
            ...
            <div style={{flex:1,padding:"14px 20px 0"}}>
              ...
              {sessions.slice(0,3).map((s,i)=>(
                <div key={s.id} onClick={()=>{setRoute("ac");setAcTab("campaigns");}} style={{display:"flex",alignItems:"center",gap:12,padding:"11px 0",borderTop:i===0?"none":`1px solid ${bd}`,cursor:"pointer"}}>
                  ...
                  <div style={{flex:1,minWidth:0}}><div style={{fontSize:14,fontWeight:400,color:navy}} className="elide">{s.slot}</div><div style={{fontSize:14,color:tm}} className="elide">{s.when}</div></div>
                      ...
                      <tr key={c.id} className="rh" onClick={()=>openCandidate(c.id)} style={{cursor:"pointer"}}>
                        <td style={acTd}>
                          <div style={{display:"flex",alignItems:"center",gap:12,minWidth:0}}>
                            <div style={{width:34,height:34,borderRadius:"50%",background:`color-mix(in srgb, var(--accent) 10%, transparent)`,color:teal,display:"flex",alignItems:"center",justifyContent:"center",fontSize:14,fontWeight:700,flexShrink:0,fontFamily:f}}>{c.name.split(" ").map(n=>n[0]).slice(0,2).join("")}</div>
                            <div style={{minWidth:0}}>
                        ...
                        <td style={acTd}>
                          <div style={{display:"flex",alignItems:"center",gap:10}}>
                            <StatusPill s={c.evalStatus}/>
                            <span className="tnum" style={{fontSize:14,color:tx,fontWeight:400}}>{c.evalDone}/{c.evalTotal}</span>
                          </div>
                        </td>
                        <td style={{...acTd,position:"relative",paddingRight:32}}><span className="row-arrow"><I.Chev s={14}/></span></td>
                      </tr>
              ...
              <div>
                {(dashSample==="3"?sessions.slice(0,3):sessions).map((s,i)=>(
                  <div key={s.id} onClick={()=>{setRoute("ac");setAcTab("campaigns");}} style={{display:"flex",alignItems:"center",gap:12,padding:"12px 20px",borderTop:i===0?"none":`1px solid ${bd}`,cursor:"pointer",transition:"background .15s"}} onMouseEnter={e=>e.currentTarget.style.background=navyBg} onMouseLeave={e=>e.currentTarget.style.background="transparent"}>
                    ...
                    <div style={{flex:1,minWidth:0}}>
                      <div style={{fontSize:14,fontWeight:400,color:navy}} className="elide">{s.slot}</div>
        ...
        <div onClick={e=>e.stopPropagation()} style={{background:card,borderRadius:18,width:"100%",height:"100%",maxWidth:1400,display:"flex",flexDirection:"column",overflow:"hidden",boxShadow:"0 30px 80px rgba(0,15,71,.4)"}}>
          <div style={{display:"flex",alignItems:"center",gap:14,padding:"16px 22px",borderBottom:`1px solid ${bd}`,flexShrink:0}}>
            ...
            <div style={{display:"flex",alignItems:"center",gap:2,border:`1px solid ${bd}`,borderRadius:9,padding:3,flexShrink:0}}>
              ...
              <span className="tnum" style={{fontSize:14,fontWeight:400,color:navy,minWidth:44,textAlign:"center"}}>{Math.round(zoom*100)}%</span>
